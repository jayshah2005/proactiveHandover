...
std::vector<double> LteRealisticChannelModel::getSINR(LteAirFrame *frame, UserControlInfo* lteInfo)
{
   ...
   std::ofstream speedFile("/home/mmayon/Research/OMNETPP/Project_GCN_LSTM_HO/simu5G/src/Datafiles/speed.txt");
...
//    std::cout << "nodeId_chnlMdl: " << nodeId_chnlMdl << " towerId_chnlMdl: " << towerId_chnlMdl << " sqrDistance: " << sqrDistance << endl;
    ...
    std::ofstream distFile("/home/mmayon/Research/OMNETPP/Project_GCN_LSTM_HO/simu5G/src/Datafiles/dist.txt");

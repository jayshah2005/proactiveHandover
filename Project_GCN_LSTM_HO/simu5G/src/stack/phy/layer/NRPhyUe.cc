...
//    std::cout << "NRPhyUe: Time HO: " << timeHO_NRPhyUe << endl;
    std::ofstream timeHOFile("/home/mmayon/Research/OMNETPP/Project_GCN_LSTM_HO/simu5G/src/Datafiles/timeHO.txt");
    timeHOFile << timeHO_NRPhyUe << endl;
    timeHOFile.close();

    eachTimeHO_NRPhyUe = handoverLatency;
//    std::cout << "NRPhyUe: Each Time HO: " << eachTimeHO_NRPhyUe << endl;
    std::ofstream eachTimeHOFile("/home/mmayon/Research/OMNETPP/Project_GCN_LSTM_HO/simu5G/src/Datafiles/eachTimeHO.txt");

...
//    std::cout << "VoIPReceiver: PLR: " << avg_plr << endl;
    ...
    std::ofstream plrHOFile("/home/mmayon/Research/OMNETPP/Project_GCN_LSTM_HO/simu5G/src/Datafiles/plrHO.txt");
    plrHOFile << avg_plr << endl;
    plrHOFile.close();

    std::ofstream eachPlrHOFile("/home/mmayon/Research/OMNETPP/Project_GCN_LSTM_HO/simu5G/src/Datafiles/eachPlrHO.txt");
